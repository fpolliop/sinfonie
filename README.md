...
- Phone client: `site/m/` (plain JS PWA, `marked` from cdnjs for markdown). Service worker shows pushes and answers permission prompts from the notification's Allow/Deny actions by POSTing an encrypted envelope to the relay.
